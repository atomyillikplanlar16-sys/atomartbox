/* ============================================
   ...
   GitHub Pages için güncellenmiş versiyon
   ============================================ */
(function () {
  'use strict';
  ...
  if (path === '/' || path === '/index.html' || path.endsWith('/index/')) {
    currentPage = 'index';
  } else if (path.includes('hakkimizda')) {
    currentPage = 'hakkimizda';
  } else if (path.includes('kit') && !path.includes('kity')) {
    currentPage = 'kit';
  } else if (path.includes('kity')) {
    currentPage = 'kity';
  } else if (path.includes('etkinlik')) {
    currentPage = 'etkinlik';
  } else if (path.includes('videolar')) {
    currentPage = 'videolar';
  }
  
  if (currentPage) {
    var current = nav.querySelector('[data-page="' + currentPage + '"]');
    if (current) {
